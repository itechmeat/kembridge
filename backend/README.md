...
curl -X POST http://localhost:4000/api/auth/verify-wallet \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0x742d35Cc6635C0532925a3b8D400a69ee0f44AD2",
    "chain_type": "ethereum",
...
**Status**: Phase 2.1 completed (39/149 tasks), ready for Phase 2.2